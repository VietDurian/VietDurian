...
# ============================================================
# 4. Build EfficientNetV2L model (Transfer Learning)
# ============================================================
...
avg_model.save("EfficientNetV2L_tendurian_avg_top5.keras")
...
cm_df.to_csv(filename)
model.save("EfficientNetV2L_durian_disease_final.keras")
