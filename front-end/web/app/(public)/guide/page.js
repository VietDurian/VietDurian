...
function Section1Content({ t }) {
  return (
    <div className="space-y-8">
          ...
          {[
            {
              ...
              color: "red",
              title: t("g_s1_c1_title"),
              desc: t("g_s1_c1_desc"),
            },
            {
              icon: <Sprout className="w-5 h-5" />,
              color: "green",
              title: t("g_s1_c2_title"),
              desc: t("g_s1_c2_desc"),
            },
            {
              icon: <ShieldCheck className="w-5 h-5" />,
              color: "blue",
              title: t("g_s1_c3_title"),
              desc: t("g_s1_c3_desc"),
            },
            {
              icon: <FileText className="w-5 h-5" />,
              color: "purple",
              title: t("g_s1_c4_title"),
              desc: t("g_s1_c4_desc"),
            },
          ].map(({ icon, color, title, desc }) => (
            <div
              key={title}
              className={`bg-white border rounded-xl p-5 shadow-sm hover:border-${color}-300 transition-colors h-full`}
            >
              <div className="flex items-center gap-3 mb-3 pb-2 border-b">
                <div
                  className={`bg-${color}-100 p-2 rounded-lg text-${color}-600`}
                >
                  {icon}
                </div>
          ...
          <table className="min-w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-100 bg-white">
              {[
                ...
                {
                  term: t("g_s1_term_hazard_label"),
                  color: "red",
                  key: "g_s1_term_hazard",
                },
                { term: "MRLs", color: "orange", key: "g_s1_term_mrls" },
                { term: "PHI", color: "blue", key: "g_s1_term_phi" },
                {
                  term: t("g_s1_term_trace_label"),
                  color: "purple",
                  key: "g_s1_term_trace",
                },
                {
                  term: t("g_s1_term_compost_label"),
                  color: "lime",
                  key: "g_s1_term_compost",
                },
                {
                  term: t("g_s1_term_audit_label"),
                  color: "teal",
                  key: "g_s1_term_audit",
                },
                {
                ...
                <tr key={key} className="hover:bg-gray-50">
                  <td className={`px-4 py-3 font-semibold text-${color}-700`}>
                    {term}
                  </td>
      ...
      <div className="bg-linear-to-r from-orange-50 to-amber-50 p-6 rounded-xl border border-orange-100">
          ...
          <ul className="space-y-3 text-sm text-gray-600 flex-1">
            {[1, 2, 3, 4].map((n) => (
              <li key={n} className="flex gap-2">
                ...
                <span
                  dangerouslySetInnerHTML={{ __html: t(`g_s2_eco_${n}`) }}
                />
              </li>
            ))}
          </ul>
        ...
        <div className="bg-white border rounded-xl p-5 shadow-sm hover:border-orange-300 transition-colors h-full flex flex-col">
          ...
          <ul className="space-y-3 text-sm text-gray-600 flex-1">
            {[1, 2, 3, 4].map((n) => (
              <li key={n} className="flex gap-2">
                <div
                  className={`w-1.5 h-1.5 ${n === 3 ? "bg-red-600" : "bg-green-600"} rounded-full mt-1.5 shrink-0`}
                />
                <span
                  dangerouslySetInnerHTML={{ __html: t(`g_s2_zone_${n}`) }}
                />
              </li>
            ))}
          </ul>
            ...
            <tbody className="divide-y divide-gray-100">
              {["chem", "bio", "phys"].map((type) => (
                <tr key={type} className="hover:bg-gray-50">
                  <td
                    className={`px-4 py-3 font-semibold text-${type === "chem" ? "red" : type === "bio" ? "yellow" : "blue"}-700`}
                  >
                    {t(`g_s2_hazard_${type}_name`)}
                    <br />
                    <span className="text-xs font-normal text-gray-500">
                      {t(`g_s2_hazard_${type}_sub`)}
                    </span>
                  </td>
                  <td className="px-4 py-3 text-gray-600 text-xs">
                    {t(`g_s2_hazard_${type}_origin`)}
                  </td>
                  <td className="px-4 py-3 text-gray-600 text-xs">
                    {t(`g_s2_hazard_${type}_control`)}
                  </td>
                </tr>
              ))}
            </tbody>
              ...
              {[1, 2, 3].map((n) => (
                <li
                  ...
                  dangerouslySetInnerHTML={{
                    __html: t(`g_s2_design_mekong_${n}`),
                  }}
                />
              ))}
            </ul>
            ...
            <ul className="space-y-1 list-disc pl-4">
              {[1, 2, 3].map((n) => (
                <li
                  key={n}
                  dangerouslySetInnerHTML={{
                    __html: t(`g_s2_design_highland_${n}`),
                  }}
                />
              ))}
            </ul>
...
function Section3Content({ t }) {
  return (
    <div className="space-y-8">
      <div className="bg-emerald-50 p-6 rounded-xl border border-emerald-200">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white p-5 rounded-lg shadow-sm">
            <h5 className="font-bold text-emerald-800 mb-3 border-b pb-2">
              {t("g_s3_std_req_label")}
            </h5>
            <ul className="space-y-2 text-sm text-gray-600">
              {[1, 2, 3, 4].map((n) => (
                <li key={n} className="flex gap-2">
                  ...
                  <span
                    dangerouslySetInnerHTML={{ __html: t(`g_s3_std_req_${n}`) }}
                  />
                </li>
              ))}
            </ul>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              {[1, 2].map((n) => (
                <li key={n} className="flex gap-2">
                  ...
                  <span
                    dangerouslySetInnerHTML={{ __html: t(`g_s3_salt_${n}`) }}
                  />
                </li>
              ))}
            </ul>
          ...
          {[
            {
              ...
              colorBorder: "yellow",
              colorBadge: "yellow",
              labelKey: "g_s3_ri6_label",
            },
            {
              key: "dona",
              colorBorder: "green",
              colorBadge: "green",
              labelKey: "g_s3_dona_label",
            },
            {
              key: "chin",
              colorBorder: "amber",
              colorBadge: "amber",
              labelKey: "g_s3_chin_label",
            },
          ].map(({ key, colorBorder, colorBadge, labelKey }) => (
            <div
              key={key}
              className={`bg-white border-2 border-${colorBorder}-200 rounded-xl p-5 shadow-sm hover:border-${colorBorder}-400 transition-colors`}
            >
              <div
                className={`bg-${colorBadge}-100 text-${colorBadge}-800 font-bold text-sm px-3 py-1 rounded-full inline-block mb-3`}
              >
                {t(labelKey)}
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                {[1, 2, 3, 4, 5, 6].map((n) => (
                  <li
                    key={n}
                    dangerouslySetInnerHTML={{ __html: t(`g_s3_${key}_${n}`) }}
                  />
                ))}
              </ul>
            </div>
      ...
      <div>
        <h4 className="font-bold text-gray-900 mb-4 text-xl">
          {t("g_s3_planting_title")}
        </h4>
        <div className="grid md:grid-cols-2 gap-5">
          <div className="bg-white border rounded-xl p-5 shadow-sm">
            <h5 className="font-bold text-gray-800 mb-3 border-b pb-2">
              {t("g_s3_plant_mekong_title")}
            </h5>
            ...
            <ul className="text-sm text-gray-600 space-y-2">
              {[1, 2].map((n) => (
                <li
                  key={n}
                  dangerouslySetInnerHTML={{
                    __html: `• ${t(`g_s3_plant_highland_${n}`)}`,
                  }}
                />
              ))}
            </ul>
            <h5 className="font-bold text-gray-800 mb-2 mt-4 border-b pb-2">
              {t("g_s3_plant_method_title")}
            </h5>
            <ul className="text-sm text-gray-600 space-y-2">
              {[1, 2].map((n) => (
                <li
          ...
          <table className="min-w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-200 bg-white">
              <tr className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3">100–200</td>
                <td className="px-4 py-3">435–652</td>
                <td className="px-4 py-3">625–1,250</td>
              ...
              <tr className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3">200–300</td>
                <td className="px-4 py-3">200–300</td>
                <td className="px-4 py-3">652–978</td>
                <td className="px-4 py-3">1,250–1,875</td>
                <td className="px-4 py-3">400–600</td>
              </tr>
              <tr className="hover:bg-gray-50">
                <td className="px-4 py-3 font-semibold">3</td>
                <td className="px-4 py-3">4–6</td>
                <td className="px-4 py-3">450–600</td>
                <td className="px-4 py-3">300–400</td>
                <td className="px-4 py-3">350–500</td>
                <td className="px-4 py-3">978–1,304</td>
                <td className="px-4 py-3">1,875–2,500</td>
              ...
              <tr className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3">600–700</td>
                <td className="px-4 py-3">1,522–1,957</td>
                <td className="px-4 py-3">2,500–3,125</td>
                <td className="px-4 py-3">1,200–1,400</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="bg-blue-50 p-4 rounded-xl border border-blue-200 mb-4 text-sm text-gray-700">
          {[1, 2].map((n) => (
            <p
              key={n}
              className={n > 1 ? "mt-1" : ""}
              dangerouslySetInnerHTML={{ __html: t(`g_s4_prod_summary_${n}`) }}
            />
          ))}
        </div>
        <div className="overflow-x-auto border rounded-xl shadow-sm">
          <table className="min-w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-200 bg-white">
              ...
              <tr className="hover:bg-gray-50">
                <td className="px-4 py-3 pl-8 text-gray-500">
                  → {t("g_s4_app")} 1
                </td>
                <td className="px-4 py-3">{t("g_s4_batch1_t1")}</td>
              ...
              <tr className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3">{t("g_s4_batch1_t2")}</td>
                <td className="px-4 py-3 text-center">12</td>
                <td className="px-4 py-3 text-center">8</td>
                <td className="px-4 py-3 text-center">5</td>
              </tr>
              <tr className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3">{t("g_s4_batch1_t3")}</td>
                <td className="px-4 py-3 text-center">12</td>
                <td className="px-4 py-3 text-center">8</td>
                <td className="px-4 py-3 text-center">5</td>
              </tr>
              <tr className="bg-yellow-50">
                ...
                <td className="px-4 py-3 text-center font-bold">40</td>
                <td className="px-4 py-3 text-center font-bold">21</td>
              </tr>
              <tr className="bg-orange-50">
                ...
                <td className="px-4 py-3 text-center font-bold">18</td>
                <td className="px-4 py-3 text-center font-bold">30</td>
              </tr>
              <tr className="hover:bg-gray-50">
                <td className="px-4 py-3 pl-8 text-gray-500">
                ...
                <td className="px-4 py-3">{t("g_s4_batch3_t1")}</td>
                <td className="px-4 py-3 text-center">12</td>
                <td className="px-4 py-3 text-center">8</td>
                <td className="px-4 py-3 text-center">5</td>
              </tr>
              <tr className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3">{t("g_s4_batch3_t2")}</td>
                <td className="px-4 py-3 text-center">12</td>
                <td className="px-4 py-3 text-center">8</td>
                <td className="px-4 py-3 text-center">5</td>
              </tr>
              <tr className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3">{t("g_s4_batch3_t3")}</td>
              ...
              <tr className="bg-blue-50">
                ...
                <td className="px-4 py-3 text-center font-bold">26</td>
                <td className="px-4 py-3 text-center font-bold">18</td>
                <td className="px-4 py-3 text-center font-bold">21</td>
              </tr>
              <tr className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3">{t("g_s4_batch4_t1")}</td>
                <td className="px-4 py-3 text-center">6</td>
                <td className="px-4 py-3 text-center">2</td>
              ...
              <tr className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3">{t("g_s4_batch4_t2")}</td>
                <td className="px-4 py-3 text-center">12</td>
                <td className="px-4 py-3 text-center">8</td>
                <td className="px-4 py-3 text-center">5</td>
              </tr>
              <tr className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3">{t("g_s4_batch4_t3")}</td>
                <td className="px-4 py-3 text-center">8</td>
                <td className="px-4 py-3 text-center">8</td>
                <td className="px-4 py-3 text-center">9</td>
              </tr>
              <tr className="bg-red-50">
                <td className="px-4 py-3 font-bold text-red-700" colSpan={2}>
                  {t("g_s4_batch5_title")}
                </td>
          ...
          <table className="min-w-full text-sm bg-white rounded-lg overflow-hidden">
            ...
            <tbody className="divide-y divide-gray-100">
              {["chem", "bio"].map((type) => (
                <tr key={type} className="hover:bg-gray-50">
                  <td
                    className={`px-4 py-3 font-semibold text-${type === "chem" ? "red" : "yellow"}-700`}
                  >
                    {t(`g_s5_hazard_${type}_name`)}
                    <br />
                    <span className="text-xs font-normal text-gray-500">
                      {t(`g_s5_hazard_${type}_sub`)}
                    </span>
                  </td>
                  <td className="px-4 py-3 text-gray-600 text-xs">
                    {t(`g_s5_hazard_${type}_origin`)}
                  </td>
                  <td className="px-4 py-3 text-gray-600 text-xs">
                    {t(`g_s5_hazard_${type}_control`)}
                  </td>
                </tr>
              ))}
            </tbody>
        ...
        <div className="bg-white border rounded-xl p-5 shadow-sm">
          ...
          <ul className="text-sm text-gray-600 space-y-2">
            {[1, 2, 3, 4].map((n) => (
              <li
                key={n}
                dangerouslySetInnerHTML={{ __html: `• ${t(`g_s5_rule_${n}`)}` }}
              />
            ))}
          </ul>
        </div>
        <div className="bg-white border rounded-xl p-5 shadow-sm">
          ...
          <ul className="text-sm text-gray-600 space-y-2">
            {[1, 2, 3, 4].map((n) => (
              <li
                key={n}
                dangerouslySetInnerHTML={{ __html: `• ${t(`g_s5_irr_${n}`)}` }}
              />
            ))}
          </ul>
        </div>
      ...
      <div className="bg-lime-50 p-5 rounded-xl border border-lime-200">
        ...
        <div className="grid md:grid-cols-2 gap-5 text-sm text-gray-700">
          <div>
            ...
            <ul className="space-y-1 list-disc pl-4">
              {[1, 2, 3].map((n) => (
                <li key={n}>{t(`g_s6_canopy_estab_${n}`)}</li>
              ))}
            </ul>
          </div>
          <div>
        ...
        <div className="grid md:grid-cols-2 gap-5">
          {[1, 2, 3, 4].map((n) => {
            ...
            return (
              <div
                key={n}
                className={`bg-${color}-50 border border-${color}-200 rounded-xl p-5`}
              >
                <div
                  className={`bg-${color}-500 text-white text-xs font-bold px-3 py-1 rounded-full inline-block mb-2`}
                >
                  {t(`g_s6_step_${n}_label`)}
                </div>
                <h5 className="font-bold text-gray-800 mb-2">
                  {t(`g_s6_step_${n}_title`)}
                </h5>
                <ul className="text-sm text-gray-600 space-y-1 list-disc pl-4">
                  {[1, 2, 3].map((i) => {
                    const val = t(`g_s6_step_${n}_item_${i}`);
                    return val && val !== `g_s6_step_${n}_item_${i}` ? (
                      <li key={i}>{val}</li>
                    ) : null;
                  })}
                </ul>
        ...
        <div className="bg-white border rounded-xl p-5 shadow-sm">
          ...
          <ul className="text-sm text-gray-600 space-y-2">
            {[1, 2, 3].map((n) => (
              <li
                key={n}
                dangerouslySetInnerHTML={{ __html: `• ${t(`g_s6_thin_${n}`)}` }}
              />
            ))}
          </ul>
        </div>
      ...
      <div className="bg-amber-50 border-l-4 border-amber-500 p-5 rounded-r-xl">
        ...
        <ul className="text-sm text-gray-700 space-y-2 list-disc pl-4">
          {[1, 2, 3, 4, 5].map((n) => (
            <li
              key={n}
              dangerouslySetInnerHTML={{ __html: t(`g_s6_fix_${n}`) }}
            />
          ))}
        </ul>
      </div>
            ...
            <ul className="space-y-1 list-disc pl-4">
              {[1, 2, 3, 4, 5].map((n) => (
                <li
                  key={n}
                  dangerouslySetInnerHTML={{
                    __html: t(`g_s6_saline_before_${n}`),
                  }}
                />
              ))}
            </ul>
            ...
            <ul className="space-y-1 list-disc pl-4">
              {[1, 2, 3, 4, 5].map((n) => (
                <li
                  key={n}
                  dangerouslySetInnerHTML={{
                    __html: t(`g_s6_saline_recover_${n}`),
                  }}
                />
              ))}
            </ul>
...
function Section7Content({ t }) {
  const pestRows = [
    {
      nameKey: "g_s7_pest1_name",
      sciKey: "g_s7_pest1_sci",
      descKey: "g_s7_pest1_desc",
      mgmtKeys: [1, 2, 3],
    },
    {
      nameKey: "g_s7_pest2_name",
      sciKey: "g_s7_pest2_sci",
      descKey: "g_s7_pest2_desc",
      mgmtKeys: [1, 2, 3],
    },
    {
      nameKey: "g_s7_pest3_name",
      sciKey: "g_s7_pest3_sci",
      descKey: "g_s7_pest3_desc",
      mgmtKeys: [1, 2, 3],
    },
    {
      nameKey: "g_s7_pest4_name",
      sciKey: "g_s7_pest4_sci",
      descKey: "g_s7_pest4_desc",
      mgmtKeys: [1, 2, 3],
    },
    {
      nameKey: "g_s7_pest5_name",
      sciKey: "g_s7_pest5_sci",
      descKey: "g_s7_pest5_desc",
      mgmtKeys: [1, 2, 3],
    },
    {
      nameKey: "g_s7_pest6_name",
      sciKey: "g_s7_pest6_sci",
      descKey: "g_s7_pest6_desc",
      mgmtKeys: [1, 2, 3],
    },
    {
      nameKey: "g_s7_pest7_name",
      sciKey: "g_s7_pest7_sci",
      descKey: "g_s7_pest7_desc",
      mgmtKeys: [1, 2, 3],
    },
  ];
  ...
  const diseaseRows = [
    {
      nameKey: "g_s7_dis1_name",
      descKey: "g_s7_dis1_desc",
      mgmtKeys: [1, 2, 3, 4, 5],
    },
  ...
  return (
    <div className="space-y-8">
      <div className="bg-linear-to-r from-blue-50 to-cyan-50 border-2 border-blue-200 rounded-xl p-6 shadow-sm">
            ...
            >
              ...
              <ul className="text-sm text-gray-600 space-y-1">
                {[1, 2].map((i) => {
                  ...
                  return val && val !== `g_s7_right_${n}_item_${i}` ? (
                    <li key={i}>• {val}</li>
                  ) : null;
                })}
              </ul>
        ...
        <div className="overflow-x-auto border rounded-xl shadow-sm">
          <table className="min-w-full text-sm">
            <thead className="bg-gray-100 font-bold text-gray-800 uppercase">
              <tr>
                <th className="px-5 py-3 text-left w-1/4">
                  {t("g_table_pest")}
                </th>
                <th className="px-5 py-3 text-left w-1/3">
                  {t("g_table_pest_desc")}
                </th>
                <th className="px-5 py-3 text-left w-1/3">
                  {t("g_table_pest_mgmt")}
                  ...
                  <td className="px-5 py-4 text-gray-700 text-xs">
                    <ul className="space-y-1">
                      {row.mgmtKeys.map((i) => {
                        ...
                        return val && val !== `g_s7_dis${idx + 1}_mgmt_${i}` ? (
                          <li key={i}>• {val}</li>
                        ) : null;
                      })}
                    </ul>
        ...
        <div className="grid md:grid-cols-2 gap-4 text-sm text-gray-700">
          ...
          <ul className="space-y-2">
            <li className="text-red-600 font-bold flex items-center gap-2">
              <XCircle className="w-4 h-4 shrink-0" /> {t("g_s7_waste_never")}
            </li>
            {[2, 3].map((n) => (
              <li
                key={n}
                dangerouslySetInnerHTML={{
                  __html: `• ${t(`g_s7_waste_right_${n}`)}`,
                }}
              />
            ))}
          </ul>
        ...
        <div className="bg-white p-5 rounded-lg mb-4">
          ...
          <ul className="text-sm text-gray-700 space-y-1 list-disc pl-5">
            {[1, 2, 3].map((n) => (
              <li
                key={n}
                dangerouslySetInnerHTML={{ __html: t(`g_s8_phi_${n}`) }}
              />
            ))}
          </ul>
        </div>
        <div className="bg-red-100 p-4 rounded-lg flex items-start gap-3">
          <Flame className="w-5 h-5 text-red-700 shrink-0 mt-0.5" />
      ...
      <div className="grid md:grid-cols-2 gap-6 items-stretch">
        <div className="bg-white border rounded-xl p-5 shadow-sm h-full flex flex-col">
          <h4 className="font-bold text-gray-900 mb-3 text-lg flex items-center gap-2">
            ...
            {t("g_s8_harvest_title")}
          </h4>
          <ul className="text-sm text-gray-600 list-disc pl-4 space-y-2 flex-1">
            {[1, 2, 3, 4, 5].map((n) => (
              <li
                key={n}
                dangerouslySetInnerHTML={{ __html: t(`g_s8_harvest_${n}`) }}
              />
            ))}
          </ul>
        </div>
        <div className="bg-white border rounded-xl p-5 shadow-sm h-full flex flex-col">
          <h4 className="font-bold text-gray-900 mb-3 text-lg flex items-center gap-2">
            ...
            {t("g_s8_hygiene_title")}
          </h4>
          <ul className="text-sm text-gray-600 list-disc pl-4 space-y-2 flex-1">
            {[1, 2, 3, 4, 5].map((n) => (
              <li
                key={n}
                dangerouslySetInnerHTML={{ __html: t(`g_s8_hygiene_${n}`) }}
              />
            ))}
          </ul>
        </div>
          ...
          <table className="min-w-full text-sm bg-white rounded-lg overflow-hidden">
            ...
            <tbody className="divide-y divide-gray-100">
              {["chem", "bio", "phys"].map((type) => (
                <tr key={type}>
                  <td
                    className={`px-4 py-2 font-semibold text-${type === "chem" ? "red" : type === "bio" ? "yellow" : "blue"}-700 text-xs`}
                  >
                    {t(`g_s8_hazard_${type}_name`)}
                  </td>
                  <td className="px-4 py-2 text-gray-600 text-xs">
                    {t(`g_s8_hazard_${type}_origin`)}
                  </td>
                  <td className="px-4 py-2 text-gray-600 text-xs">
                    {t(`g_s8_hazard_${type}_control`)}
                  </td>
                </tr>
              ))}
            </tbody>
          ...
          <div>
            ...
            <ul className="space-y-1 list-disc pl-4">
              {[1, 2, 3].map((n) => (
                <li
                  key={n}
                  dangerouslySetInnerHTML={{ __html: t(`g_s8_storage_${n}`) }}
                />
              ))}
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-1 list-disc pl-4">
              {[1, 2, 3].map((n) => (
                <li
                  key={n}
                  dangerouslySetInnerHTML={{ __html: t(`g_s8_transport_${n}`) }}
                />
              ))}
            </ul>
          </div>
      ...
      <div className="bg-emerald-50 p-6 rounded-xl border border-emerald-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          {[
            ...
            <div
              key={n}
              className="bg-white p-5 rounded-xl flex items-start gap-4 shadow-sm border border-emerald-100 hover:shadow-md transition-shadow h-full"
            >
              <div
                className={`p-3 bg-${color}-100 text-${color}-600 rounded-lg shrink-0`}
              >
                {icon}
              </div>
              <div>
                <span className="block font-bold text-gray-800 text-lg mb-1">
                  {t(`g_s9_form${n}_title`)}
                </span>
        ...
        <div className="bg-green-50 border border-green-200 rounded-xl p-5">
          ...
          <ul className="text-sm text-gray-700 space-y-2 list-disc pl-4">
            {[1, 2, 3].map((n) => (
              <li
                key={n}
                dangerouslySetInnerHTML={{ __html: t(`g_s9_emission_${n}`) }}
              />
            ))}
          </ul>
        </div>
    ...
    () => [
      {
        ...
        titleKey: "guide_s1_title",
        descKey: "guide_s1_desc",
        icon: <ShieldCheck className="w-6 h-6" />,
        sourceKey: "guide_s1_source",
        Content: Section1Content,
      },
      {
        id: "vung-san-xuat",
        titleKey: "guide_s2_title",
        descKey: "guide_s2_desc",
        icon: <MapPin className="w-6 h-6" />,
        sourceKey: "guide_s2_source",
        Content: Section2Content,
      },
      {
        id: "cay-giong-trong",
        titleKey: "guide_s3_title",
        descKey: "guide_s3_desc",
        icon: <Sprout className="w-6 h-6" />,
        sourceKey: "guide_s3_source",
        Content: Section3Content,
      },
      {
        id: "phan-bon-nuoc-tuoi",
        titleKey: "guide_s4_title",
        descKey: "guide_s4_desc",
        icon: <Layers className="w-6 h-6" />,
        sourceKey: "guide_s4_source",
        Content: Section4Content,
      },
      {
        id: "nuoc-tuoi",
        titleKey: "guide_s5_title",
        descKey: "guide_s5_desc",
        icon: <Droplets className="w-6 h-6" />,
        sourceKey: "guide_s5_source",
        Content: Section5Content,
      },
      {
        id: "tao-tan-xu-ly-ra-hoa",
        titleKey: "guide_s6_title",
        descKey: "guide_s6_desc",
        icon: <Scissors className="w-6 h-6" />,
        sourceKey: "guide_s6_source",
        Content: Section6Content,
      },
      {
        id: "quan-ly-sau-benh",
        titleKey: "guide_s7_title",
        descKey: "guide_s7_desc",
        icon: <Bug className="w-6 h-6" />,
        sourceKey: "guide_s7_source",
        Content: Section7Content,
      },
      {
        id: "thu-hoach",
        titleKey: "guide_s8_title",
        descKey: "guide_s8_desc",
        icon: <Package className="w-6 h-6" />,
        sourceKey: "guide_s8_source",
        Content: Section8Content,
      },
      {
        id: "nhat-ky-vietgap",
        titleKey: "guide_s9_title",
        descKey: "guide_s9_desc",
        icon: <ClipboardCheck className="w-6 h-6" />,
        sourceKey: "guide_s9_source",
              ...
              <nav className="space-y-2">
                {guideSections.map((section) => (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 text-left border-l-4 ${
                  ...
                  >
                    <span
                      className={`shrink-0 ${activeSection === section.id ? "text-emerald-600" : "text-gray-400"}`}
                    >
                      {section.icon}
                    </span>
                        ...
                        {section.sourceKey && (
                          <p className="text-xs text-blue-600 mt-2 flex items-center gap-1">
                            ...
                            <span className="italic">
                              {t("guide_source_label")}: {t(section.sourceKey)}
                            </span>
                          </p>
                        )}
                      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs text-gray-600">
            {[1, 2, 3, 4, 5, 6].map((n) => (
              <div key={n} className="flex items-start gap-2">
                ...
                <span
                  dangerouslySetInnerHTML={{ __html: t(`guide_ref_${n}`) }}
                />
              </div>
            ))}
          </div>
