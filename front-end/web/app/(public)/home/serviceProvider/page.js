...
import {
    FileText, ArrowRight, Eye, CheckCircle2, Handshake,
    BookOpen, MessageCircle, Star, MapPin, ChevronLeft, ChevronRight,
    Wrench, Droplets, Scissors, Bug, BadgeCheck, Users,
    ClipboardList, PhoneCall, BarChart3, ShieldCheck, Gift, Sprout,
} from "lucide-react";
...
const SERVICE_FEATURES = [
    { icon: <Droplets className="w-5 h-5 text-emerald-600" />, label: "Phun thuốc BVTV đúng kỹ thuật" },
    { icon: <Sprout className="w-5 h-5 text-emerald-600" />, label: "Bón phân định kỳ theo mùa vụ" },
    { icon: <Scissors className="w-5 h-5 text-emerald-600" />, label: "Cắt tỉa tạo tán chuyên nghiệp" },
    { icon: <Bug className="w-5 h-5 text-emerald-600" />, label: "Kiểm định chất lượng sản phẩm" },
    { icon: <ShieldCheck className="w-5 h-5 text-emerald-600" />, label: "Đảm bảo an toàn, có chứng chỉ" },
];
...
const SP_STEPS = [
    {
        step: "01", icon: <FileText className="w-8 h-8" />,
        title: "Đăng bài dịch vụ", color: "from-emerald-400 to-emerald-600", glow: "shadow-emerald-500/40",
        desc: "Mô tả dịch vụ chi tiết, khu vực phục vụ và bảng giá. Nông dân tìm kiếm dịch vụ sẽ thấy bạn ngay.",
        highlight: "Miễn phí đăng bài", highlightIcon: <Gift className="w-4 h-4" />,
    },
    {
        step: "02", icon: <PhoneCall className="w-8 h-8" />,
        title: "Nhận liên hệ từ nông dân", color: "from-yellow-400 to-yellow-500", glow: "shadow-yellow-500/40",
        desc: "Nông dân cần dịch vụ sẽ chủ động liên hệ, hỏi giá và đặt lịch. Chat nhanh, thống nhất ngay trên nền tảng.",
        highlight: "Chat trực tiếp", highlightIcon: <MessageCircle className="w-4 h-4" />,
    },
    {
        step: "03", icon: <Star className="w-8 h-8" />,
        title: "Hoàn thành & nhận đánh giá", color: "from-teal-400 to-emerald-500", glow: "shadow-teal-500/40",
        desc: "Thực hiện dịch vụ chuyên nghiệp, nhận đánh giá từ khách hàng. Điểm uy tín tăng, đơn hàng mới tự đến.",
        highlight: "Xây dựng uy tín", highlightIcon: <Star className="w-4 h-4" />,
    },
];
        ...
        <div className="bg-white py-20 px-4 border-y border-gray-100">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-14">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">Nhà cung cấp dịch vụ có thể làm gì?</h2>
                    <p className="text-gray-500 max-w-2xl mx-auto">Nền tảng giúp bạn tiếp cận hàng trăm nông dân, xây dựng uy tín và phát triển dịch vụ bền vững</p>
                </div>
    ...
    return (
        <div className="min-h-screen bg-gray-50">
                        ...
                        <div className="relative z-10 px-8 md:px-16 pt-12 pb-14">
                            ...
                            <div className="text-center mb-10">
                                <h1 className="text-5xl md:text-6xl font-bold text-white mb-4 drop-shadow leading-tight">
                                    Cung cấp Dịch vụ<br />
                                    <span className="text-yellow-300">Nông nghiệp Chuyên nghiệp</span>
                                </h1>
                                <p className="text-emerald-50 text-lg max-w-2xl mx-auto leading-relaxed">
                                    Kết nối với nông dân · Xây dựng uy tín · Phát triển dịch vụ bền vững
                                </p>
                            </div>
            ...
            <div className="bg-gradient-to-br from-emerald-950 via-emerald-900 to-teal-900 py-20 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-white mb-3">Quy trình nhận đơn hàng</h2>
                        <p className="text-emerald-300 max-w-xl mx-auto">Đăng bài · Nhận liên hệ · Hoàn thành & tích lũy uy tín</p>
                    </div>
            ...
            <div className="bg-gray-50 py-20 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-14">
                        <span className="inline-block bg-emerald-100 text-emerald-700 text-xs font-bold px-4 py-1.5 rounded-full mb-4 border border-emerald-200 uppercase tracking-widest">Nhu cầu thị trường</span>
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">Dịch vụ nông dân đang cần nhất</h2>
                        <p className="text-gray-500 max-w-xl mx-auto">Cơ hội việc làm rộng mở — chọn lĩnh vực phù hợp và bắt đầu nhận đơn ngay</p>
                    </div>
                    <div className="grid md:grid-cols-3 gap-5">
                        {[
                            { icon: <Droplets className="w-6 h-6 text-emerald-600" />, name: "Phun thuốc BVTV", demand: "120+ yêu cầu/tháng", desc: "Phun thuốc trừ sâu, bệnh nấm theo mùa vụ — cần thiết bị chuyên dụng và chứng chỉ an toàn." },
                            { icon: <Sprout className="w-6 h-6 text-emerald-600" />, name: "Bón phân định kỳ", demand: "85+ yêu cầu/tháng", desc: "Bón phân NPK, hữu cơ theo từng giai đoạn sinh trưởng của sầu riêng." },
                            { icon: <Scissors className="w-6 h-6 text-emerald-600" />, name: "Cắt tỉa tạo tán", demand: "60+ yêu cầu/tháng", desc: "Tỉa cành tạo tán thông thoáng, kích thích ra hoa — cần kỹ thuật và kinh nghiệm cao." },
                            { icon: <Bug className="w-6 h-6 text-emerald-600" />, name: "Kiểm định chất lượng", demand: "45+ yêu cầu/tháng", desc: "Đánh giá chất lượng sầu riêng trước thu hoạch, hỗ trợ nông dân đạt chuẩn xuất khẩu." },
                            { icon: <ClipboardList className="w-6 h-6 text-emerald-600" />, name: "Thu hoạch & vận chuyển", demand: "70+ yêu cầu/tháng", desc: "Cung cấp đội thu hoạch, xe tải vận chuyển sầu riêng đến kho/điểm giao hàng." },
                            { icon: <ShieldCheck className="w-6 h-6 text-emerald-600" />, name: "Tư vấn kỹ thuật", demand: "30+ yêu cầu/tháng", desc: "Hỗ trợ nông dân xử lý sâu bệnh, lập kế hoạch canh tác, đăng ký VietGAP." },
                        ].map((t) => (
            ...
            <div className="bg-white py-20 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-14">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">Lợi ích khi tham gia nền tảng</h2>
                        <p className="text-gray-500 max-w-xl mx-auto">Tại sao nhà cung cấp dịch vụ chọn DurianFarm để phát triển?</p>
                    </div>
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            { icon: <Users className="w-8 h-8 text-emerald-900" />, num: "01", title: "Tiếp cận khách hàng rộng", desc: "Kết nối trực tiếp với hàng trăm nông dân đang cần dịch vụ. Không cần chi phí quảng cáo, không qua trung gian — khách hàng tự tìm đến bài đăng của bạn.", tags: ["Khách hàng tiềm năng", "Không phí quảng cáo"] },
                            { icon: <Star className="w-8 h-8 text-emerald-900" />, num: "02", title: "Xây dựng uy tín thực tế", desc: "Mỗi đơn hàng hoàn thành giúp tích lũy điểm đánh giá. Uy tín cao, hồ sơ đầy đủ — nông dân tin tưởng và ưu tiên chọn bạn hơn đối thủ.", tags: ["Đánh giá thực tế", "Hồ sơ xác minh"] },
                            { icon: <BarChart3 className="w-8 h-8 text-emerald-900" />, num: "03", title: "Tăng doanh thu ổn định", desc: "Mở rộng vùng dịch vụ, nhận nhiều đơn hàng hơn trong mùa vụ cao điểm. Theo dõi lịch làm việc, quản lý đơn hàng ngay trên nền tảng.", tags: ["Quản lý đơn hàng", "Thu nhập ổn định"] },
                        ].map((a) => (
                            <div key={a.title} className="group bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border border-gray-100">
                                ...
                                <div className="p-7">
                                    <div className="flex items-center gap-4 mb-6">
                                        <div className="w-14 h-14 bg-yellow-400 rounded-xl flex items-center justify-center flex-shrink-0 shadow-md group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">{a.icon}</div>
            ...
            <div className="max-w-5xl mx-auto px-4 py-16">
                <div className="bg-emerald-500 rounded-3xl p-12 text-center">
                    <h2 className="text-3xl font-bold text-white mb-3">Bắt đầu cung cấp dịch vụ ngay hôm nay</h2>
                    <p className="text-emerald-100 mb-8 max-w-xl mx-auto">
                        Hàng trăm nông dân đang tìm kiếm dịch vụ chuyên nghiệp — đăng bài và nhận đơn ngay
                    </p>
