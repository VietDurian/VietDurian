...
const POST_TYPES = [
  {
    ...
    desc: "Chia sẻ quy trình canh tác, chăm sóc sầu riêng từng giai đoạn",
    tag: "Phổ biến",
  ...
  },
  {
    ...
    label: "Kinh nghiệm",
    desc: "Bí quyết thực tế, bài học từ nhiều năm trồng và chăm sóc sầu riêng",
    tag: "Cộng đồng",
  ...
  },
  {
    ...
    bg: "bg-amber-50 border-amber-300 hover:border-amber-500 hover:bg-amber-100",
    label: "Thuê dịch vụ",
    desc: "Tìm xe vận chuyển, đội thu hoạch, phun thuốc, bón phân thuê",
    tag: "Hữu ích",
  ...
  },
  {
    ...
    bg: "bg-yellow-50 border-yellow-300 hover:border-yellow-500 hover:bg-yellow-100",
    label: "Khác",
    desc: "Hỏi đáp, thông báo, chia sẻ thông tin hữu ích về ngành sầu riêng",
    tag: "Tự do",
...
const BLOG_FEATURES = [
  {
    ...
    label: "Cấu trúc rõ ràng theo từng phần",
  },
  {
    icon: <Zap className="w-5 h-5 text-emerald-600" />,
    label: "Thêm hình ảnh, video minh họa",
  },
  {
    icon: <CheckCircle2 className="w-5 h-5 text-emerald-600" />,
    label: "Tài liệu tham khảo khoa học",
  },
  {
    icon: <BookMarked className="w-5 h-5 text-emerald-600" />,
    label: "Cập nhật theo mùa vụ thực tế",
  },
  {
    icon: <Users className="w-5 h-5 text-emerald-600" />,
    label: "Nông dân có thể hỏi & đánh giá",
  },
];
...
const TOPICS = [
  {
    ...
    name: "Chọn giống",
    desc: "Hướng dẫn chọn giống Ri6, Musang King, Monthong phù hợp vùng đất",
  },
  {
    icon: <Droplets className="w-5 h-5 text-emerald-600" />,
    name: "Kỹ thuật tưới",
    desc: "Tưới nhỏ giọt, tưới phun — tiết kiệm nước, đúng giai đoạn sinh trưởng",
  },
  {
    icon: <Lightbulb className="w-5 h-5 text-emerald-600" />,
    name: "Bón phân",
    desc: "Lịch bón theo từng giai đoạn: ra lá, ra hoa, nuôi trái, sau thu hoạch",
  },
  {
    icon: <Scissors className="w-5 h-5 text-emerald-600" />,
    name: "Cắt tỉa",
    desc: "Tỉa cành tạo tán thông thoáng, kích thích ra hoa đồng loạt đúng mùa",
  },
  {
    icon: <Bug className="w-5 h-5 text-emerald-600" />,
    name: "Phòng & trị bệnh",
    desc: "Nhận biết sớm thối rễ, xì mủ, rầy, nhện đỏ và cách xử lý hiệu quả",
  },
  {
    icon: <SunMedium className="w-5 h-5 text-emerald-600" />,
    name: "Thu hoạch",
    desc: "Nhận biết sầu riêng chín, thời điểm hái và bảo quản sau thu hoạch",
  },
  {
    icon: <FlaskConical className="w-5 h-5 text-emerald-600" />,
    name: "Thuốc BVTV",
    desc: "Dùng đúng loại, đúng liều — an toàn cho người, đạt chuẩn xuất khẩu",
  },
  {
    icon: <Leaf className="w-5 h-5 text-emerald-600" />,
    name: "Canh tác hữu cơ",
    desc: "Hướng đến VietGAP, GlobalGAP — nâng giá trị và mở rộng thị trường",
  },
  {
    icon: <BookMarked className="w-5 h-5 text-emerald-600" />,
    name: "Nhật ký vườn",
    desc: "Cách ghi chép nhật ký canh tác minh bạch để nông dân dễ theo dõi và truy xuất",
  },
];
...
const BLOG_STEPS = [
  {
    ...
    title: "Chọn chủ đề & soạn nội dung",
    desc: "Chọn chủ đề canh tác bạn am hiểu, viết bài có cấu trúc rõ ràng với hình ảnh và tài liệu tham khảo.",
  ...
  },
  {
    ...
    title: "Tổ chức theo từng block",
    desc: "Nội dung được chia thành các phần — giới thiệu, các bước thực hiện, lưu ý — dễ đọc và dễ áp dụng tại vườn.",
  ...
  },
  {
    ...
    title: "Đăng & lan tỏa",
    desc: "Bài viết hiển thị cho toàn bộ nông dân trên nền tảng. Nông dân có thể lưu và đặt câu hỏi trực tiếp với bạn.",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-14">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">
            Chuyên gia nội dung có thể làm gì?
          </h2>
          <p className="text-gray-500 max-w-2xl mx-auto">
            Bạn là người cung cấp tri thức — cầu nối giữa kiến thức khoa học và
            thực tiễn canh tác của nông dân
          </p>
        </div>
            ...
            <div className="relative z-10 px-8 md:px-16 pt-12 pb-14">
              ...
              <div className="text-center mb-10">
                ...
                <p className="text-emerald-50 text-lg max-w-2xl mx-auto leading-relaxed">
                  Chuẩn hóa quy trình · Lan tỏa kiến thức · Hỗ trợ nông dân làm
                  đúng kỹ thuật
                </p>
              </div>
                    ...
                    <div className="relative z-10 flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-yellow-50 text-[13px] mt-0.5">
                          Chia sẻ với cộng đồng nông dân
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="group bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden flex flex-col transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-emerald-500/10">
                  ...
                  <div className="p-5 bg-white flex flex-col flex-1">
                    <p className="text-gray-500 text-[13px] mb-4 leading-snug">
                      Soạn bài blog chuyên sâu về kỹ thuật canh tác — nội dung
                      được tổ chức thành các mục rõ ràng, dễ đọc cho nông dân.
                    </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-3">
              Quy trình viết Blog kiến thức
            </h2>
            <p className="text-emerald-300 max-w-xl mx-auto">
              Từ ý tưởng đến bài viết chất lượng — lan tỏa đến hàng nghìn nông
              dân
            </p>
          </div>
      ...
      <div className="bg-gray-50 py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">
              Chủ đề nông dân quan tâm nhất
            </h2>
            <p className="text-gray-500 max-w-xl mx-auto">
              Chọn một chủ đề và bắt đầu đóng góp kiến thức của bạn
            </p>
          </div>
      ...
      <div className="bg-gray-50 py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">
              Lợi ích khi chia sẻ kiến thức
            </h2>
            <p className="text-gray-500 max-w-xl mx-auto">
              Kiến thức của bạn có thể thay đổi cách hàng nghìn nông dân canh
              tác
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {
                icon: <Award className="w-8 h-8 text-emerald-900" />,
                num: "01",
                title: "Xây dựng uy tín chuyên gia",
                desc: "Bài viết chất lượng giúp bạn được cộng đồng nông dân và thương lái nhận diện là chuyên gia uy tín trong ngành.",
                tags: ["Huy hiệu Chuyên gia", "Được cộng đồng tin tưởng"],
              },
              {
                icon: <Eye className="w-8 h-8 text-emerald-900" />,
                num: "02",
                title: "Tiếp cận cộng đồng rộng",
                desc: "Blog và bài viết của bạn hiển thị cho toàn bộ nông dân, thương lái trên nền tảng — không giới hạn phạm vi địa lý.",
                tags: ["Hiển thị toàn quốc", "Không giới hạn"],
              },
              {
                icon: <Heart className="w-8 h-8 text-emerald-900" />,
                num: "03",
                title: "Góp phần phát triển ngành",
                desc: "Chuẩn hóa quy trình canh tác, nâng cao chất lượng sầu riêng Việt Nam — hướng tới tiêu chuẩn xuất khẩu quốc tế.",
                tags: ["Đóng góp cộng đồng", "Nâng chuẩn ngành"],
              },
            ].map((b) => (
              <div
                key={b.title}
      ...
      <div className="max-w-5xl mx-auto px-4 py-16">
        <div className="bg-emerald-500 rounded-3xl p-12 text-center">
          <h2 className="text-3xl font-bold text-white mb-3">
            Bắt đầu chia sẻ kiến thức ngay hôm nay
          </h2>
