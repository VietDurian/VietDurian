        ...
        <div className="min-h-screen bg-gray-50">
                            ...
                            <div className="max-w-3xl mx-auto">
                                <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
                                    ...
                                    <div className="p-7">
                                        ...
                                        {/* ── CTA button → /profile/posts/create ── */}
                                        <Link
            ...
            <div className="bg-gradient-to-br from-emerald-900 via-emerald-800 to-teal-900 py-16 px-4">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            { icon: <Search className="w-8 h-8 text-emerald-900" />, iconBg: "bg-emerald-300", num: "01", title: "Tìm kiếm thông minh", desc: "Lọc chính xác theo khu vực, giống cây (Ri6, Musang King...), thời gian thu hoạch và sản lượng ước tính. Xem vị trí vườn trên bản đồ trực tiếp.", tags: ["Lọc đa tiêu chí", "Bản đồ vườn"] },
                            { icon: <Eye className="w-8 h-8 text-teal-900" />, iconBg: "bg-teal-300", num: "02", title: "Nhật ký canh tác minh bạch", desc: "Xem đầy đủ lịch sử phân bón, thuốc BVTV, ngày chăm sóc và sản lượng dự kiến — trước khi quyết định thu mua, không cần đến tận nơi.", tags: ["Lịch sử canh tác", "Sản lượng ước tính"] },
                            { icon: <TrendingDown className="w-8 h-8 text-emerald-900" />, iconBg: "bg-emerald-300", num: "03", title: "Giảm chi phí trung gian", desc: "Chat và thương lượng giá trực tiếp với nông dân. Không qua môi giới, không mất phí hoa hồng — lợi nhuận thu mua tối ưu hơn.", tags: ["Chat trực tiếp", "Không hoa hồng"] },
                        ].map((a) => (
                            <div key={a.title} className="bg-white/10 backdrop-blur-sm border border-white/15 rounded-2xl p-7 hover:bg-white/15 transition-all group">
                                <div className="flex items-start gap-4 mb-5">
                                    <div className={`w-14 h-14 ${a.iconBg} rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg group-hover:scale-105 transition-transform`}>{a.icon}</div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {a.tags.map((t) => (
                                        <span key={t} className="bg-white/10 text-emerald-200 text-xs font-medium px-3 py-1 rounded-full border border-white/10">✓ {t}</span>
                                    ))}
                                </div>
                            </div>
                        ))}
