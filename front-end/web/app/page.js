  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 px-4 lg:px-6 bg-emerald-500 relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">{t('journey_title')}</h2>
            <p className="text-emerald-100 text-lg max-w-3xl mx-auto">{t('journey_subtitle')}</p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={step.titleKey} className="relative">
                  <div className={`bg-white rounded-2xl p-6 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:-translate-y-2 border-t-4 ${step.border} min-h-[280px] flex flex-col`}>
      ...
      <section className="py-20 px-4 lg:px-6 bg-white relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">{t('connection_title')}</h2>
            <p className="text-gray-600 text-lg max-w-3xl mx-auto">{t('connection_subtitle')}</p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] gap-8 items-center">
                ...
                <div className="relative flex items-start gap-5">
                  ...
                  <div className="flex-1 pt-1">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="text-2xl font-bold text-gray-900">{t('scenario_farmer')}</h3>
              ...
              <div className="group relative bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-r-4 border-cyan-500">
                <div className="relative flex items-start gap-5">
                  ...
                  <div className="flex-1 pt-1">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="text-2xl font-bold text-gray-900">{t('s1_responder_title')}</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] gap-8 items-center">
              ...
              <div className="group relative bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-r-4 border-indigo-500">
                <div className="relative flex items-start gap-5">
                  ...
                  <div className="flex-1 pt-1">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="text-2xl font-bold text-gray-900">{t('s2_responder_title')}</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] gap-8 items-center">
              ...
              <div className="group relative bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-r-4 border-orange-500">
                <div className="relative flex items-start gap-5">
                  ...
                  <div className="flex-1 pt-1">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="text-2xl font-bold text-gray-900">{t('s3_responder_title')}</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] gap-8 items-center">
              ...
              <div className="group relative bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-r-4 border-purple-500">
                <div className="relative flex items-start gap-5">
                  ...
                  <div className="flex-1 pt-1">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="text-2xl font-bold text-gray-900">{t('s4_responder_title')}</h3>
      ...
      <section className="relative py-16 px-4 lg:px-6 bg-emerald-500 overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto relative z-10">
          <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12">{t('products_title')}</h2>
          {products.length === 0 ? (
                          ...
                          <div className="bg-white rounded-lg overflow-hidden shadow-md border border-gray-100">
                            <div className="p-5">
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <button className="px-6 py-2.5 bg-emerald-600 text-white rounded-full font-medium hover:bg-emerald-700 transition-colors text-sm">{t('products_contact')}</button>
                              </div>
                            </div>
                          </div>
                        </div>
      ...
      <section className="py-16 px-4 lg:px-6 bg-gray-50">
        <div className="max-w-[1400px] mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 text-center mb-4">{t('blog_title')}</h2>
          <p className="text-center text-gray-500 mb-12">{t('blog_subtitle')}</p>
          <div className="relative">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch select-none pointer-events-none" style={{ filter: "blur(3px)", opacity: 0.6 }}>
              ...
              <div className="flex flex-col gap-4 h-full">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="bg-white rounded-lg overflow-hidden border border-gray-200 flex flex-1">
                    <div className="w-32 flex-shrink-0 bg-gradient-to-br from-lime-100 to-emerald-100 flex items-center justify-center"><BookOpen className="w-8 h-8 text-emerald-300" /></div>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="bg-white rounded-2xl shadow-2xl p-8 mx-4 max-w-md w-full text-center border border-emerald-100">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">{t('blog_login_title')}</h3>
