            ...
            <section className="pt-28 pb-16 px-4 lg:px-6">
                <div className="max-w-4xl mx-auto text-center">
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                        Nền Tảng Kết Nối & Phát Triển Ngành Sầu Riêng Việt Nam
                    </h1>
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
                        VietDurian - Cầu nối giữa kiến thức kỹ thuật, thị trường và cộng đồng người trồng sầu riêng,
                        hướng tới nền nông nghiệp bền vững và chất lượng cao
                    </p>
                </div>
            </section>
            {/* Video Section */}
                ...
                <div className="max-w-[1400px] mx-auto px-4 lg:px-6 space-y-16">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className="text-white">
                            ...
                            <p className="text-lg text-emerald-50 leading-relaxed">
                                VietDurian hỗ trợ cộng đồng nông dân Việt Nam trong việc phát triển bền vững ngành sầu riêng
                                thông qua việc cung cấp kiến thức kỹ thuật chuyên sâu, kết nối thị trường và xây dựng
                                chuỗi giá trị minh bạch, góp phần nâng cao chất lượng cuộc sống và bảo vệ môi trường.
                            </p>
                        </div>
                        <div className="relative h-72 rounded-xl overflow-hidden shadow-lg">
                            <Image
                                src="/images/Durian3.jpg"
                                alt="Sầu riêng trồng bền vững"
                                fill
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="order-1 lg:order-2 text-white">
                            ...
                            <p className="text-lg text-emerald-50 leading-relaxed">
                                Trở thành nguồn tham khảo kiến thức kỹ thuật hàng đầu về sầu riêng tại Việt Nam,
                                nơi kết nối người trồng với chuyên gia và thị trường, góp phần xây dựng chuỗi giá trị
                                sầu riêng minh bạch, chất lượng cao và thúc đẩy nền nông nghiệp xanh, bền vững trong khu vực.
                            </p>
                        </div>
                    </div>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all border-t-4 border-emerald-600">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-4 text-center">Chất Lượng</h3>
                            <p className="text-gray-600 leading-relaxed text-center">
                                Cam kết cung cấp kiến thức chuyên sâu, sản phẩm và dịch vụ chất lượng cao,
                                đáp ứng nhu cầu phát triển bền vững của nông dân và ngành sầu riêng Việt Nam.
                            </p>
                        </div>
                        ...
                        <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all border-t-4 border-emerald-600">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-4 text-center">Bền Vững</h3>
                            <p className="text-gray-600 leading-relaxed text-center">
                                Thúc đẩy phương pháp canh tác VietGAP, hữu cơ và thân thiện với môi trường,
                                xây dựng chuỗi giá trị sầu riêng minh bạch và phát triển lâu dài.
                            </p>
                        </div>
                        ...
                        <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all border-t-4 border-emerald-600">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-4 text-center">Kết Nối</h3>
                            <p className="text-gray-600 leading-relaxed text-center">
                                Tạo cầu nối giữa người trồng, chuyên gia, thị trường và cộng đồng,
                                xây dựng mạng lưới hỗ trợ toàn diện cho sự phát triển của ngành sầu riêng.
                            </p>
                        </div>
