...
export function UserDetail({ userId, isOpen, onClose }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-[2px] px-4 py-6">
            <div className="relative w-full max-w-sm sm:max-w-md overflow-hidden rounded-[24px] bg-white shadow-[0_20px_60px_rgba(0,0,0,0.18)] border border-gray-100">
                <button
                ...
                {loading ? (
                    <div className="p-8">
                        <div className="h-36 rounded-[20px] bg-gradient-to-r from-sky-100 via-fuchsia-100 to-rose-100 animate-pulse" />
                    ...
                    <>
                        <div className="h-36 w-full bg-gradient-to-r from-sky-200 via-fuchsia-200 to-rose-300" />
                        ...
                        <div className="relative px-5 pb-5">
                            <div className="-mt-12 flex items-end gap-4">
                                <div className="shrink-0 rounded-full border-4 border-white bg-white shadow-md">
                                    {avatar ? (
                                        ...
                                        <div className="flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-[#1a4d2e] to-[#2d7a4f] text-3xl font-bold text-white">
                            ...
                            <div className="mt-4">
                                <h2 className="text-[28px] leading-tight font-bold text-gray-900 break-words">
                                    {fullName}
                                </h2>

                                {role ? (
                                    <p className="mt-1 text-sm font-medium text-[#6b6ee8] break-words">
                                        {role}
                                    </p>
                                ) : null}
                            </div>
