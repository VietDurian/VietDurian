...
export default function CreatePostPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!canSubmit) {
      setError(t("create_post_required"));
      return;
    }
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                placeholder={
                  contactType === "phone"
                    ? t("create_post_contact_phone_placeholder")
                    : t("create_post_contact_email_placeholder")
                }
              ...
              {!imagePreview ? (
                ...
                >
                  ...
                  <p className="text-sm font-medium text-gray-600">
                    {t("create_post_image_click")}
                  </p>
                  <p className="text-xs text-gray-400 mt-1">
                    {t("create_post_image_hint")}
                  </p>
                </div>
              ) : (
