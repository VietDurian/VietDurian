...
const TabButton = ({ icon: Icon, label, active, onClick }) => (
  <button
    onClick={onClick}
    className={`relative flex items-center gap-3 px-6 py-4 rounded-xl transition-all duration-300 ${active ? "bg-emerald-500 text-white" : "text-gray-600 hover:bg-gray-100 hover:text-gray-900"}`}
  >
    <Icon
      size={20}
...
const RoleBadge = ({ role, t }) => {
  const roleConfig = {
    ...
    contentExpert: {
      label: t("role_contentExpert"),
      color: "from-purple-500 to-pink-500",
    },
    serviceProvider: {
      label: t("role_serviceProvider"),
...
const PasswordRule = ({ rule, password }) => {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <span
        className={`text-sm ${isValid ? "text-emerald-600" : "text-gray-500"}`}
      >
        {rule.label}
      </span>
    </div>
  ...
  const passwordRules = [
    {
      ...
      label: t("profile_pw_rule1"),
    },
    {
      id: "uppercase",
      test: (pwd) => /[A-Z]/.test(pwd),
      label: t("profile_pw_rule2"),
    },
    {
      id: "lowercase",
      test: (pwd) => /[a-z]/.test(pwd),
      label: t("profile_pw_rule3"),
    },
    {
      id: "number",
      test: (pwd) => /\d/.test(pwd),
      label: t("profile_pw_rule4"),
    },
    {
      id: "special",
      test: (pwd) => /[!@#$%^&*(),.?":{}|<>[\]\\';`~+=\-_/]/.test(pwd),
      label: t("profile_pw_rule5"),
    },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8 bg-white rounded-2xl p-2 border border-gray-200">
          <div className="flex gap-2">
            <TabButton
              icon={User}
              label={t("profile_tab_profile")}
              active={activeTab === "profile"}
              onClick={() => setActiveTab("profile")}
            />
            <TabButton
              icon={Heart}
              label={t("profile_tab_favorites")}
              active={activeTab === "favorites"}
              onClick={() => setActiveTab("favorites")}
            />
            <TabButton
              icon={Shield}
              label={t("profile_tab_security")}
                ...
                <div className="space-y-4 max-w-2xl">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700 outline-none focus:ring-0"
                      >
                  ...
                  >
                    {isChangingPassword ? (
                      ...
                      t("profile_update_pw_btn")
                    )}
                  </button>
                  {passwordForm.newPassword && (
                    <div className="p-4 bg-gray-50 rounded-xl space-y-2">
                      <p className="text-sm font-semibold text-gray-700 mb-2">
                        {t("profile_pw_rules_title")}
                      </p>
          ...
          <div className="bg-white rounded-2xl max-w-2xl w-full">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">
                    {t("profile_phone")} <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="tel"
                    name="phone"
