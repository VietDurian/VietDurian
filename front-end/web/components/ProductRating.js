...
export default function ProductRating({ productId, userId }) {
  ...
  const [isReviewDetailModalVisible, setIsReviewDetailModalVisible] =
    useState(false);
    ...
    try {
      ...
      if (response.success) {
        ...
        const formattedReviews = ratingsData.map((rating) => {
          ...
          const starsValue =
            typeof stars === "object" && stars?.$numberDecimal
  ...
  const handleSubmitRating = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        toast.success(
          isEditMode
            ? t("rating_toast_update_success")
            : t("rating_toast_submit_success"),
        );
        handleCloseRatingModal();
        await fetchRatings();
      } else {
      ...
      toast.error(
        isEditMode
          ? t("rating_toast_update_fail")
          : t("rating_toast_already_rated"),
      );
      handleCloseRatingModal();
    }
  };
    ...
    <div className="max-w-350 mx-auto px-4 py-12">
      ...
      <div className="mb-16">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-center mb-8">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex gap-2">{renderStars(averageRating)}</div>
        ...
        <div className="flex gap-3">{renderStars(userRating, true)}</div>
      </div>
      ...
      <div className="overflow-x-auto pb-4">
        <div className="flex gap-6 min-w-min">
          ...
          {userOwnRating && (
            <div
              className="shrink-0 w-[320px] h-35 bg-white border-2 border-emerald-600 rounded-xl p-4 cursor-pointer hover:shadow-lg transition-all"
          ...
          >
            <div className="flex justify-between items-center p-8 border-b border-gray-200">
              <h2 className="text-3xl font-bold text-gray-900">
                {isEditMode
                  ? t("rating_modal_title_edit")
                  : t("rating_modal_title_new")}
              </h2>
              <button
            ...
            <div className="p-8">
              ...
              <div className="flex justify-center gap-3">
                <button
                  ...
                  className="flex-1 max-w-50 px-6 py-3 border-2 border-emerald-600 text-emerald-600 font-bold rounded-lg hover:bg-emerald-600 hover:text-white transition-all"
                >
                  {isEditMode
                    ? t("rating_modal_update")
                    : t("rating_modal_submit")}
                </button>
                ...
                {isEditMode && (
                  <button
                    ...
                    className="flex-1 max-w-50 px-6 py-3 bg-red-600 text-white font-bold rounded-lg hover:bg-red-700 transition-all"
                  >
        ...
        >
          ...
          >
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="bg-gray-50 rounded-lg p-4 min-h-37.5">
