...
const HIDE_HEADER_SCREENS = ["chat-detail", "comment", "blog-detail", "product-detail"];
...
function ScreenRouter() {
  ...
  switch (currentScreen) {
    ...
    case "blogs": return <BlogsScreen />;
    case "blog-detail": return <BlogDetailScreen />;
    ...
    case "AI": return <AIScanScreen />;
    case "comment": return <CommentScreen onBack={() => navigate("home")} />;
